...
namespace EssentialUIKit.Data
{
    public class RestAPI2{
        private const string horariosService_Get = "http://192.168.1.137:8480/hubcolumbiatest/rest/mobileService/horarioAlumno?cedula=6948405";
        private const string examenesService_Get = "http://192.168.1.137:8480/hubcolumbiatest/rest/mobileService/examenesAlumno?cedula=6948405";
        private const string calificacionesService_Get = "http://192.168.1.137:8480/hubcolumbiatest/rest/mobileService/calificacionAlumno?cedula=6948405&mostrar=todas";
        private const string financieroService_Get = "http://192.168.1.137:8480/hubcolumbiatest/rest/mobileService/financieroAlumno?cedula=6948405&mostrar=todas";
        private const string asistenciaService_Get = "http://192.168.1.137:8480/hubcolumbiatest/rest/mobileService/asistenciaAlumno?cedula=6948405";
        private const string perfilService_Get = "http://192.168.1.137:8480/hubcolumbiatest/rest/mobileService/perfil?cedula=2024952";
